...
Use a deterministic color library or named conversion tool for every value. The examples below are reference pairs, not permission to estimate nearby colors by eye.
